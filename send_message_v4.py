...
while (len(number) != 0):
    try:
        ...
        try:
            ...
            element = WebDriverWait(browser, 20).until(EC.presence_of_element_located((By.XPATH , '//*[@id="main"]/footer/div[1]/div/span[2]/div/div[2]/div[1]')))

        except Exception as e:
            print("url not reachable for " + str(num))
            print(e)
